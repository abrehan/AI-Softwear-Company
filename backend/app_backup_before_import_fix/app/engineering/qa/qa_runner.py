...
class QARunner:
    """
    PHASE 6 â€” INTEGRATED QA RUNNER
    ...
    async def run_endpoint_tests(
        ...
        print()
        print(
            "ðŸŒ Running integration HTTP tests..."
        )
        ...
        async with httpx.AsyncClient(
            ...
            print(
                ...
                + f" â€” HTTP {result.get('status_code')}"
            )
    ...
    async def run(self) -> dict[str, Any]:
        ...
        print("=" * 60)
        print(
            "ðŸ§ª PHASE 6 â€” INTEGRATED QA RUNNER"
        )
        print("=" * 60)
        ...
        try:
            ...
            if await self.server_is_running():
                ...
                print(
                    "â™»ï¸ Existing FastAPI server detected."
                )

                print(
                    "â„¹ï¸ QA will use the existing server."
                )
            ...
            if success:
                ...
                print(
                    "ðŸŽ‰ ALL PHASE 6 QA TESTS PASSED"
                )

            else:

                print(
                    "âŒ PHASE 6 QA TESTS FAILED"
                )
